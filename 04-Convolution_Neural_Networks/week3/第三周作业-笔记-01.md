...
![](C:\Users\Think\Desktop\吴恩达笔记\04-Convolution Neural Networks\week3\imgs_videos\driveai.png)

​		你已经将所有这些图片收集到一个文件夹中，并通过在你找到的每辆车周围绘制边界框来标记它们。下面是一个你的边界框的样子的例子。

![](C:\Users\Think\Desktop\吴恩达笔记\04-Convolution Neural Networks\week3\imgs_videos\box_label.png)
...
![](C:\Users\Think\Desktop\吴恩达笔记\04-Convolution Neural Networks\week3\imgs_videos\architecture.png)
...
![](C:\Users\Think\Desktop\吴恩达笔记\04-Convolution Neural Networks\week3\imgs_videos\flatten.png)

​		现在，对于（每个单元格的）每个框，我们将计算以下元素积，并提取框包含某个类的概率。

![](C:\Users\Think\Desktop\吴恩达笔记\04-Convolution Neural Networks\week3\imgs_videos\probability_extraction.png)
...
![](C:\Users\Think\Desktop\吴恩达笔记\04-Convolution Neural Networks\week3\imgs_videos\proba_map.png)

​		注意，这种可视化并不是yolo算法本身进行预测的核心部分；它只是可视化算法中间结果的一种好方法。

​		另一种可视化yolo输出的方法是绘制它输出的边界框。这样做会产生如下可视化效果：

![](C:\Users\Think\Desktop\吴恩达笔记\04-Convolution Neural Networks\week3\imgs_videos\anchor_map.png)
...
![](C:\Users\Think\Desktop\吴恩达笔记\04-Convolution Neural Networks\week3\imgs_videos\non-max-suppression.png)
